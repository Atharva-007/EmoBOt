      ...
      switch (index) {
        ...
        case 2:
          ...
          Navigator.push(
            context,
            PageRouteBuilder(
              pageBuilder: (context, animation, secondaryAnimation) => const ThemesPage(),
              transitionsBuilder: (context, animation, secondaryAnimation, child) {
                return SlideTransition(
                  position: Tween<Offset>(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  boxShadow: widget.isSelected
                      ? [
                          BoxShadow(
                            color: widget.theme.colorScheme.primary.withOpacity(0.4),
                            blurRadius: 15,
                  ...
                  children: [
                    ...
                    if (widget.isSelected)
                      AnimatedBuilder(
                        ...
                        builder: (context, child) {
                          return Container(
                            width: 60 * (1 + widget.animationController.value * 0.3),
                            height: 60 * (1 + widget.animationController.value * 0.3),
                            decoration: BoxDecoration(
                              shape: BoxShape.circle,
                              border: Border.all(
                                color: widget.theme.colorScheme.primary.withOpacity(
                                  0.4 * (1 - widget.animationController.value),
                                ),
                                width: 2,
                              ),
                            ),
