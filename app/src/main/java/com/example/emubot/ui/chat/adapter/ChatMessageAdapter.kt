package com.example.emubot.ui.chat.adapter
...
import com.example.emubot.databinding.ItemMessageBotBinding
import com.example.emubot.databinding.ItemMessageUserBinding
...
class ChatMessageAdapter : ListAdapter<ChatMessage, RecyclerView.ViewHolder>(ChatMessageDiffCallback()) {
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        ...
        animateMessageEntrance(holder.itemView, position)
    }

    private fun animateMessageEntrance(view: android.view.View, position: Int) {
        view.alpha = 0f
